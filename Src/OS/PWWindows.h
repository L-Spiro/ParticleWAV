...
#include <stdexcept>
//#include <winnt.h>
inline uint64_t PW_FASTCALL _umul128( uint64_t _ui64Multiplier, uint64_t _ui64Multiplicand, 
...
inline uint64_t PW_FASTCALL _udiv128( uint64_t _ui64High, uint64_t _ui64Low, uint64_t _ui64Divisor, uint64_t * _pui64Remainder ) {
	if ( _ui64Divisor == 0 ) {
